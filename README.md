...
- **API** — stateless, read-only JSON API. Phase 4 is underway with Fastify metadata/OpenAPI endpoints, explicit `VersionHandle` discovery, public language-tag normalization, Office/day composition payloads, calendar month summaries, and deterministic cache headers/ETags.
