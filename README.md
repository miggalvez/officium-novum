...
- **API** — stateless, read-only JSON API. Phase 4 is underway with Fastify metadata/OpenAPI endpoints, explicit `VersionHandle` discovery, public language-tag normalization, Office composition, and deterministic cache headers/ETags.
